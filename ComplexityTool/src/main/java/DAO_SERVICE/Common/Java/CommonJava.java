package DAO_SERVICE.Common.Java;
...
//		 System.out.println("The type of Language is : " + language);
		...
		System.out.println("The lines of method name are given below \n");
			 ...
			 if(stArray[y].contains("public") || stArray[y].contains("private") || stArray[y].contains("protected")  ) { 
				// Modifier Checked
				 if(stArray[y].contains("void") ||stArray[y].contains("int") ||stArray[y].contains("long") || stArray[y].contains("float") || stArray[y].contains("double")   || stArray[y].contains("boolean") ||stArray[y].contains("String") || stArray[y].contains("ArrayList")) {
					// Return Type Checked
